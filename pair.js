...
*▫️𝐇𝐀𝐒𝐇𝐔 𝐌𝐃 𝐌𝐀𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 🌐*
> https://whatsapp.com/channel/0029VbC13d4LNSa757g9hW3x
`;
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                {
                                    title: 'MENU 📌',
                                    description: '𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐇𝐀𝐒𝐇𝐔-𝐌𝐃',
...
`;
                            ...
                            rows: [
                                {
                                    ...
                                    description: '𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝗛𝗔𝗦𝗛𝗨-𝗠𝗗',
    ...
    const ownerName = '𝐌𝐑 𝐇𝐀𝐒𝐇𝐔𝐔';
    const organization = '*𝐇𝐀𝐒𝐇𝐀𝐍-𝐌𝐃* WHATSAPP BOT DEVALOPER 🍬';
  ...
  break;
    ...
    try {
        const url = `https://hashu-md-mini.onrender.com/code?number=${encodeURIComponent(number)}`;// heroku app link එක දාපන් 
        ...
        await socket.sendMessage(sender, {
            text: `> *HASHU-MD MINI BOT PAIR COMPLETED* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
